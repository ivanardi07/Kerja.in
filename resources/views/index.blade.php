...
@section('content')
    ...
    <div class="main_slider" style="background-image:url({{ asset('assets/images/bg2.jpg')}})">
            ...
            <div class="row align-items-center fill_height">
                <div class="col">
                    <div class="main_slider_content">
                        ...
                        <div class="red_button shop_now_button"><a href="/category/{{ $menu->slug }}">pesan sekarang</a></div>
                        @endforeach
                    </div>
                </div>
            </div>
                            ...
                            <a href="/product/{{$product->slug}}">
                                ...
                                <div class="product discount product_filter">
                                    ...
                                    <div class="product_info">
                                        ...
                                        <div class="product_price">Rp {{ number_format($product->product_price) }}<span>Rp {{ number_format($product->original_price ) }}
                                                </span></div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="deal_ofthe_week_img">
                        <img src="{{ asset('assets/images/cecan.png')}}" alt="">
                    </div>
                </div>
