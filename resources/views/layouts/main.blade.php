                                ...
                                @else
                                    <li class="account">
                                        ...
                                        <ul class="account_selection">
                                            ...
                                            @if(Auth::user())
                                                <li><b>USER</b></li>
                                                <li><a href="{{ url('/profile') }}"><i class="fa fa-btn fa-user"></i>Profil</a>
                                                </li>
                                                <li><a href="{{ url('/orders') }}"><i class="fa fa-btn fa-list-alt"></i>Pesanan</a>
                                                </li>
                                            @endif
                    ...
                    <li class="menu_item has-children">
                        ...
                        <ul class="menu_selection">
                            ...
                            @if(Auth::user())
                                ...
                                <li><a href="{{ url('/orders') }}"><i class="fa fa-btn fa-list-alt"></i>Pesanan</a></li>
                            @endif
                            <li><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out"></i>Logout</a>
                            </li>
                        </ul>
