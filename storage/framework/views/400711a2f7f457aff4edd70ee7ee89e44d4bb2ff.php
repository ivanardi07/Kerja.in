    ...
    <header class="header trans_300">
        ...
        <div class="top_nav">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="top_nav_left">Marketplace Kerja.in</div>
                    </div>
                                        ...
                                        <ul class="account_selection">
                                            <?php if(Auth::user()->isItAuthorized("admin")): ?>
                                                ...
                                                <li><a href="<?php echo e(url('/admin-users')); ?>"><i
                                                                class="fa fa-btn fa-users"></i>User</a>
                                                </li>
                                                ...
                                                <li><a href="<?php echo e(url('/admin-products')); ?>"><i
                                                                class="fa fa-btn fa-cubes"></i>Produk</a>
                                                </li>
                                                <li><a href="<?php echo e(url('/admin-orders')); ?>"><i
                                                                class="fa fa-btn fa-cogs"></i>Pesanan User</a></li>
                                                <li class="divider"></li>
                                            <?php endif; ?>

                                            <?php if(Auth::user()): ?>
                                                <li><b>USER</b></li>
                                                <li><a href="<?php echo e(url('/profile')); ?>"><i class="fa fa-btn fa-user"></i>Profil</a>
                                                </li>
                                                <li><a href="<?php echo e(url('/orders')); ?>"><i class="fa fa-btn fa-list-alt"></i>Pesanan</a>
                                                </li>
                                            <?php endif; ?>
                    ...
                    <div class="col-lg-12 text-right">
                        ...
                        <nav class="navbar">
                            <ul class="navbar_menu">
                                ...
                                <li><a href="<?php echo e(route('contact')); ?>">TENTANG KAMI</a></li>
                    ...
                    <li class="menu_item has-children">
                        ...
                        <ul class="menu_selection">
                            ...
                            <?php if(Auth::user()): ?>
                                ...
                                <li><a href="<?php echo e(url('/orders')); ?>"><i class="fa fa-btn fa-list-alt"></i>Pesanan</a></li>
                            <?php endif; ?>
                            <li><a href="<?php echo e(url('/logout')); ?>"><i class="fa fa-btn fa-sign-out"></i>Logout</a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-6">
                    <div class="footer_social d-flex flex-row align-items-center justify-content-lg-end justify-content-center">
                        <ul>
                            ...
                            <li><a href="http://www.instagram.com/ivanwhynot"><i class="fa fa-instagram"
                                                                                aria-hidden="true"></i></a></li>
                            <li><a href="https://github.com/aruwansha/kerjain-api-service"><i class="fa fa-github"
                                                                             aria-hidden="true"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer_nav_container">
                        <div class="cr">©2020 Website Kerja.in 
                            by <a href="#">Kelompok 2</a></div>
                    </div>
                </div>
            </div>
        </div>
