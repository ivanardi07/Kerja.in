                    ...
                    <div class="order-summary-content">
                        <?php if(count(Cart::content())>0): ?>
                            <table class="shop_cart">
                                <thead>
                                <tr>
                                    <th class="product-name">NAMA JASA LAYANAN</th>
                                ...
                                <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productCartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="cart_item">
                                        ...
                                        <td data-title="Total" class="product-subtotal">
                                            <span>Rp <?php echo e($productCartItem->price); ?></span>
                                        </td>
                                        <td data-title="Total" class="product-remove">
                                            <span>Rp <?php echo e(($productCartItem->price) * ($productCartItem->qty)); ?></span>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-md-12 col-sm-12 text-right">
                                <div class="wc-proceed-to-checkout">
                                    <p>SUBTOTAL <span><?php echo e(Cart::subtotal()); ?> + pajak</span></p>
                                    <p>TOTAL <span>Rp <?php echo e(Cart::total()); ?></span></p>
